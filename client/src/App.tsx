...
const App = () => {
  ...
  return (<div className="bg-[#D5A105] flex justify-center items-center min-h-screen w-full">
    <div className="flex flex-col gap-5  bg-[#FEF8E8]  sm: p-10 rounded-xl" >
      ...
      {result && (
        <div className="mt-6 p-4 rounded-lg shadow-md bg-green-50 border">
          ...
          <h3 className="font-semibold mb-1">Emotion Scores:</h3>
          <ul className="list-disc list-inside text-sm text-gray-700">
            {Object.entries(result.full_scores).map(([emotion, score]) => (
              <li key={emotion}>
